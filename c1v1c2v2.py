...
if CalcDeseado == "c1":
    v1 = int(input("Introduce el volumen 1: "))
    c2 = int(input("Introduce la concentración 2: "))
    v2 = int(input("Introduce el volumen 2: "))
    c1 = (c2*v2)/v1
    print(f'{"tu concentracion 1 es "}{c1}')
if CalcDeseado == "v1":
    c1 = int(input("Introduce la concentración 1: "))
    c2 = int(input("Introduce la concentración 2: "))
    v2 = int(input("Introduce el volumen 2: "))
    v1 = (c2*v2)/c1
